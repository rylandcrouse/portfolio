...
const Sample = ({title, emoji}: Props) => {
  ...
  return (
    <div onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} className="aspect-[7/8] max-h-[70vh] w-full min-w-1/3 lg:px-10 px-14 py-10 max-w-[700px]
    flex flex-col justify-evenly items-center space-y-5
    rounded-xl border-neutral-900/60 xl:border-none
    hover:cursor-pointer hover:bg-slate-900/60 sm:hover:scale-105 hover:scale-none hover:ease-out duration-300
