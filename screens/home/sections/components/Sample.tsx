...
const Sample = ({title, emoji, repoURL}: Props) => {
  ...
  return (
        ...
        sm:w-1/3 w-full h-full sm:aspect-square aspect-[9/2] border-neutral-900/30 sm:border-r border
        hover:cursor-pointer md:hover:bg-slate-900/60 lg:hover:scale-[101%] hover:ease-out duration-300
        font-normal bg-gradient-to-r from-zinc-900/30 to-zinc-800/20">
